...
OfflineRunResult OfflineBatchRunner::Run(DataSet dataset) const {
  ...
  run_result.run_summary.rtk_outage_boundary_horizontal_velocity_delta_factor_count = 0;
  ...
  if (active_stage2_reference != nullptr &&
    ...
    boundary_request.velocity_delta_records = &velocity_delta_records;
  ...
  attitude_reference_request.tilt_reference_states =
    &base_graph_optimized_reference_states;
  attitude_reference_request.yaw_reference_states = &reference_node_states;
