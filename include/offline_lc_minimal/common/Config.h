...
struct OfflineRunnerConfig {
  ...
  bool enable_late_static_initial_acc_norm_std_threshold = true;
  double late_static_initial_acc_norm_std_scale = 1.2;
  int late_static_initial_acc_norm_std_min_sample_count = 100;
  ...
  bool enable_stage2_velocity_optimization = true;
  ...
  bool enable_stage3_vertical_reference_optimization = true;
  Stage3VerticalReferenceSmoothingMethod stage3_vertical_reference_smoothing_method =
    Stage3VerticalReferenceSmoothingMethod::kSplineBaseline;
  double stage3_vertical_reference_lowpass_cutoff_hz = 0.01;
  ...
  double stage3_vertical_anchor_sigma_m = 0.001;
  ...
  bool stage3_disable_stage2_vehicle_nhc_constraint = true;
  bool enable_stage3_jump_velocity_smoothness_regularizer = false;
  double stage3_jump_velocity_smoothness_deadband_mps = 0.008;
  double stage3_jump_velocity_smoothness_sigma_mps = 0.005;
  bool enable_stage3_jump_height_highfreq_deadband = false;
  double stage3_jump_height_highfreq_deadband_m = 0.00085;
  double stage3_jump_height_highfreq_sigma_m = 0.0012;
  bool enable_stage3_stage2_vertical_increment_hold = true;
  double stage3_stage2_vertical_increment_sigma_m = 0.0002;
  double stage3_stage2_vertical_increment_jump_sigma_m = 0.0005;
  bool enable_stage3_stage2_jump_shape_hold = true;
  double stage3_stage2_jump_shape_sigma_m = 0.0005;
  ...
  double stage3_jump_context_velocity_floor_mps = 0.0;
  double stage3_jump_context_height_floor_m = 0.0;
  double stage3_jump_context_velocity_cap_mps = 0.008;
  double stage3_jump_context_height_cap_m = 0.00085;
  ...
  bool vertical_velocity_delta_skip_jump_padding = true;
  double vertical_velocity_delta_target_acc_limit_mps2 = 0.85;
  bool enable_vertical_velocity_delta_high_noise_target_acc_limit_scale = true;
  double vertical_velocity_delta_high_noise_target_acc_limit_scale = 4.0;
